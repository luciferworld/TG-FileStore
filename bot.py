    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("BotsList Channel", url="https://t.me/digitalhub04")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Bots Channel", url="https://t.me/digitalhub04"),
                        InlineKeyboardButton(" Free vps", url="https://cloud.atlantic.net/r/cggqrw65")
                    ]
                ]
            )
        )
    ...
    if "aboutbot" in cb_data:
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("BotsList Channel", url="https://t.me/luciferbots12")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("About Dev", callback_data="aboutdevs"),
                    ...
                    [
                        InlineKeyboardButton("Support Channel", url="https://t.me/digitalhub04"),
                        InlineKeyboardButton("Free Vps", url="https://cloud.atlantic.net/r/cggqrw65")
                    ]
                ]
            )
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact me [Support](https://t.me/lucifer6985).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact me [Support](https://t.me/lucifer6985).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
